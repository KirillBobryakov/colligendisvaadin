package com.bkv.colligendis.views.masterdetail;

import com.bkv.colligendis.data.entity.SamplePerson;
import com.bkv.colligendis.data.service.SamplePersonService;
...
public class MasterDetailView extends Div implements BeforeEnterObserver {
    ...
    private final String SAMPLEPERSON_ID = "0";
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        Optional<Long> samplePersonId = event.getRouteParameters().get(SAMPLEPERSON_ID).map(Long::valueOf);
        if (samplePersonId.isPresent()) {
            Optional<SamplePerson> samplePersonFromBackend = samplePersonService.get(samplePersonId.get()).blockOptional();
